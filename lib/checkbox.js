...
/***/ function(module, exports, __webpack_require__) {
	...
	var CHECKBOX_CLASS = CLASS_PREFIX + 'checkbox';
	var CHECKBOX_ACTIVE = CHECKBOX_CLASS + '-active';
	var CHECKBOX_DISABLED = CHECKBOX_CLASS + '-disabled';
	var INNER_CLASS = CHECKBOX_CLASS + '-inner';
	var INPUT_CLASS = CHECKBOX_CLASS + '-input';
	var LABEL_CLASS = CHECKBOX_CLASS + '-label';
	  ...
	  _createClass(Checkbox, [{
	    ...
	    value: function render() {
	      ...
	      var _props = this.props,
	          ...
	          rest = _objectWithoutProperties(_props, ['className', 'checked', 'disabled', 'children', 'onChange']);

	      var classes = (0, _classnames2.default)(className, CHECKBOX_CLASS, (_Classnames = {}, _defineProperty(_Classnames, CHECKBOX_DISABLED, disabled), _defineProperty(_Classnames, CHECKBOX_ACTIVE, this.state.checked), _Classnames));

	      var reactDOM = _react2.default.createElement(
	        'div',
	        { className: classes, onClick: this.handleChangeState },
	        _react2.default.createElement('span', { className: INNER_CLASS }),
	        _react2.default.createElement('input', _extends({}, rest, { disabled: disabled, checked: this.state.checked, className: INPUT_CLASS, type: 'checkbox', onChange: this.handleChange })),
